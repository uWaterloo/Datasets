...
with open('sessions.csv', 'wb') as f:
	writer = csv.writer(f)
	writer.writerow(["id", "employer", "date", "time", "location", "website", "coop/grad", "programs", "info"])
	for session in sessions:
		writer.writerow([session["id"], session["employer"], session["date"], session["time"], session["location"], session["website"], session["coop/grad"], session["programs"], session["info"]])
